...
describe('error handling', () => {
  ...
  describe.skip('alternative error handling strategy:  get whatever you can', () => {
    it('should reject if every graph branch fails', () => {
      return new AsyncGraph()
        .addNode({
          id: 'id1',
          run: () => Promise.reject(new Error('id1')),
        })
        .addNode({
          id: 'id2',
          run: () => Promise.reject(new Error('id2')),
        ...
        .addNode({
          id: 'id3',
          run: () => Promise.reject(new Error('id3')),
          dependencies: ['id2'],
        })
        .addNode({
          id: 'id4',
        ...
        .addNode({
          id: 'id5',
          run: () => Promise.reject(new Error('id5')),
          dependencies: ['id4'],
        })
        .resolve()
    ...
    it('should resolve with successfull nodes and omit failed nodes from result', async () => {
      return new AsyncGraph()
        .addNode({
          id: 'id1',
          run: () => Promise.resolve('id1'),
        })
        .addNode({
          id: 'id2',
          run: () => Promise.resolve('id2'),
        })
        .addNode({
          id: 'id3',
          run: () => Promise.resolve('id3'),
          dependencies: ['id2'],
        })
        .addNode({
          id: 'id4',
        ...
        .resolve()
        .should.eventually.equal({ id1: 'id1', id2: 'id2', id3: 'id3' });
    });
  });
});
